            ...
            try (Connection conn = DB.connect()) {
                ...
                try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
                    ...
                    while (rs.next()) {
                        ...
                        System.out.println("\u001B [30mProduct ID: " + productId + " is low in stock. Quantity available: " + quantityAvailable + "\u001B [0m");
                    }
                }
                ...
                if (userinput.equals("inventory")) {
                    ...
                    try (var conn = DB.connect();
                        ...
                        while (rs.next()) {
                            ...
                            System.out.println(productId + ". " + name + " | " + description + " | " + quantity_available + " | " + category + " - " + price + " CHF");
                        }
                    } catch (SQLException e) {
                        e.printStackTrace();
                    }
